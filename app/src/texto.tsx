...
// fontSize y el lineHeight por el factor del sistema (tope 1,25×): lo medido y lo dibujado coinciden.
import React, { forwardRef } from "react";
import { StyleSheet, Text as RNText, TextProps, TextStyle, useWindowDimensions } from "react-native";

export const ESCALA_MAX = 1.25; // pedido del dueño: con más, los importes se parten en dos líneas y confunden
